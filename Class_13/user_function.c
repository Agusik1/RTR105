...
// char dialogs_i(int i_dialogs_arg); // argumenti var būt daudzi (secība ir svarīģa)
// piemēram
void test1(int a, int b, int c); // atslēgas vārds void nozīmē, ka return nebūs 
void test2(int a, double b); // datu tips katram argumentam

// funkcijas definēšana (var būt uzreiz definēšana bez deklarēšanas;
//			 definēšana var būt ievietota pēc main apraksta;
//			 deklarēšanai un definēšanai ir jābūt pirms f-jas izmantošanas)
