...
int main()
 ...
 if(1); // iekš () var būt "apaļā" nulle (visi biti ir ar 0)
        // vai bitu secība, kas satur vismaz vienu bitu ar 1
 int a = 10;
 ...
 if(a > 7)
  {
   printf("Darbību bloks, kas tiks izpildīta, ja \"nosacījums ir spēkā\".\n");
 ...
 // ja ļoti gribas kaut ko elif veidīgo
 /*
 if(nosacījums_a)
  {
  ;
