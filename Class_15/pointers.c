...
//*i_pointer = (*i_pointer)++ // inkrements šeit nestrādā, jo pirmkārt,
			     // tam zemāka prioritate, otrkārt, izgūta vērtība 
	 		      // iekš () vairs nav saistīta ne ar kodu mainīgo, ...
...
printf("\n\nd_value (found by identificatior) = %f\n",d_value);
...
// 0c -> 0d -> e -> 0f - 4 bytes for i_value
